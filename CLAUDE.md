...
- **当前阶段**：产品设计 + 技术架构规划
- **关键文档**：
  - [[项目/创世界-产品设计规格]] — 完整产品规格
  - [[项目/创世界-技术架构考量]] — 技术选型与考量
- **核心决策**：前端 React+Vite / 后端 Python FastAPI / Claude API / PostgreSQL+pgvector / Celery 异步任务
- **待解决**：VPN 依赖问题（Claude API 被墙，需要代理方案或国内模型备选）
